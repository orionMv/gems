        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <h3 class="box-title text-uppercase"> Create New Employee </h3>
                              
                </div><!-- /.box-header -->
                <div class="box-body">
                
                {!! Form::Open(['url'=>'/employees/create', 'method'=>'POST', 'files'=>'False']) !!}
                ...
                {!! Form::text('name',null,['class'=>'form-control','placeholder'=>'Enter employees name!']); !!}
                ...
                {!! Form::text('designation',null,['class'=>'form-control','placeholder'=>'Designation / Job title']); !!}
                ...
                {!! Form::select('department',isset($departments) ? $departments : [''=>'none'],null,['class'=>'form-control']); !!}
                ...
                {!! Form::text('username',null,['class'=>'form-control','placeholder'=>'Username / Email']); !!}
                ...
                {!! Form::text('started_at',null,['class'=>'form-control','placeholder'=>'Started At']); !!}
